//
//  ScanSuccessJumpViewController.m
//  XRHQRCodeExample
//
...
@interface ScanSuccessJumpViewController () <SGWebViewDelegate>

@property (strong, nonatomic) SGWebView *webView;

@end

@implementation ScanSuccessJumpViewController
